...
**Weather WebApp** is a simple web application that allows users to search for weather information by city. The app fetches data from the OpenWeatherMap API and displays temperature, weather conditions, and a matching weather emoji. It includes error handling for invalid city names or API issues.
